...
import idetector.dal.caching.repository.MethodRepository;
...
public class MethodRefService {
    ...
    public MethodReference getMethodRefById(String id){
        return methodRepository.findMethodReferenceById(id);
    }
